...
ITEM_TABLE: dict[str, ChibiRoboItemData] = {
    ...
    "Squirter Chibi-Gear": ChibiRoboItemData("Item", IC.useful, 4, 0x08, "item_tyuusyaki"),
    "Range Chip": ChibiRoboItemData("Item", IC.useful, 5, 0x06, "item_chip_54"),
    ...
    "Living Room Frog Ring (Behind Window)": ChibiRoboItemData("Item", IC.progression, 31, 0x00, "item_frog_ring"),
    "Living Room Frog Ring (Corkboard)": ChibiRoboItemData("Item", IC.progression, 32, 0x00, "item_frog_ring"),
    "Living Room Frog Ring (Shelf)": ChibiRoboItemData("Item", IC.progression, 33, 0x00, "item_frog_ring"),
    "Kitchen Frog Ring (Table)": ChibiRoboItemData("Item", IC.progression, 34, 0x00, "item_frog_ring"),
    "Sink Drain Frog Ring": ChibiRoboItemData("Item", IC.progression, 35, 0x00, "item_frog_ring"),
