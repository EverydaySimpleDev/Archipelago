...
ITEM_TABLE: dict[str, ChibiRoboItemData] = {
    ...
    "C Battery": ChibiRoboItemData("Item", IC.filler, 13, 0x3b, "item_denchi_2"),
    "AA Battery": ChibiRoboItemData("Item", IC.filler, 14, 0x3c, "item_denchi_3"),
    "D Battery": ChibiRoboItemData("Item", IC.filler, 15, 0x3a, "item_denchi_1"),
    "Red Shoe": ChibiRoboItemData("Item", IC.filler, 16, 0x3d, "item_peets_kutu"),
    "Green Crayon": ChibiRoboItemData("Item", IC.filler, 17, 0x96, "item_kure_4"),
    "Red Crayon": ChibiRoboItemData("Item", IC.filler, 18, 0x93, "item_kure_1"),
    "Purple Crayon": ChibiRoboItemData("Item", IC.filler, 19, 0x97, "item_kure_5"),
    "Chibi-Battery": ChibiRoboItemData("Item", IC.filler, 21, 0x9e, "item_c_denchi"),
    "Dinahs Teeth": ChibiRoboItemData("Item", IC.filler, 22, 0x58, "item_rex_tooth"),
    "Scurvy Splinter": ChibiRoboItemData("Item", IC.filler, 23, 0x72, "npc_hock_ship_114"),
    "Red Brick": ChibiRoboItemData("Item", IC.filler, 24, 0x7a, "item_t_block_6"),
    "Chibi-Radar Chibi-Gear": ChibiRoboItemData("Item", IC.progression, 25, 0x83, "cb_radar"),
    "Ticket Stub": ChibiRoboItemData("Item", IC.filler, 26, 0x66, "item_ticket"),
    "Foyer Waterfall Frog Ring": ChibiRoboItemData("Item", IC.filler, 27, 0x00, "item_frog_ring"),
    "Basement Frog Ring": ChibiRoboItemData("Item", IC.filler, 28, 0x00, "item_frog_ring"),
    "Backyard Frog Ring": ChibiRoboItemData("Item", IC.filler, 29, 0x00, "item_frog_ring"),
    "Jenny's Room Frog Ring": ChibiRoboItemData("Item", IC.filler, 30, 0x00, "item_frog_ring"),
    "Living Room Frog Ring (Behind Window)": ChibiRoboItemData("Item", IC.filler, 31, 0x00, "item_frog_ring"),
    "Living Room Frog Ring (Corkboard)": ChibiRoboItemData("Item", IC.filler, 32, 0x00, "item_frog_ring"),
    "Living Room Frog Ring (Shelf)": ChibiRoboItemData("Item", IC.filler, 33, 0x00, "item_frog_ring"),
    "Kitchen Frog Ring (Table)": ChibiRoboItemData("Item", IC.filler, 34, 0x00, "item_frog_ring"),
    "Sink Drain Frog Ring": ChibiRoboItemData("Item", IC.filler, 35, 0x00, "item_frog_ring"),
    "Green Brick": ChibiRoboItemData("Item", IC.filler, 36, 0x78, "item_t_block_4"),
    "White Brick": ChibiRoboItemData("Item", IC.filler, 37, 0x77, "item_t_block_3"),
    "Yellow Brick": ChibiRoboItemData("Item", IC.filler, 38, 0x79, "item_t_block_5"),
    "Purple Brick": ChibiRoboItemData("Item", IC.filler, 39, 0x7a, "item_t_block_2"),
    "Bandage": ChibiRoboItemData("Item", IC.filler, 40, 0x67, "item_houtai"),
    "Dog Tags": ChibiRoboItemData("Item", IC.filler, 41, 0x65, "item_tug"),
    "Hot Rod": ChibiRoboItemData("Item", IC.filler, 42, 0x7b, "item_car_item"),
    "Gunpower": ChibiRoboItemData("Item", IC.filler, 43, 0x62, "item_kayaku"),
    "Free Rangers Photo": ChibiRoboItemData("Item", IC.filler, 44, 0x7a, "item_army_photo"),
    "Passed-out Frog": ChibiRoboItemData("Item", IC.filler, 45, 0x7f, "item_frog"),
    "Yellow Crayon": ChibiRoboItemData("Item", IC.filler, 46, 0x97, "item_kure_3"),
    "Snorkel": ChibiRoboItemData("Item", IC.filler, 47, 0x63, "item_goggle"),
    "junk_item": ChibiRoboItemData("Junk", IC.useful, 48, 0x12, "item_junk_a"),
    "Blue Brick": ChibiRoboItemData("Item", IC.filler, 49, 0x7a, "item_t_block_1"),
    "Space Scrambler": ChibiRoboItemData("Item", IC.filler, 50, 0x6b, "item_nwing_item"),
    "Coin C": ChibiRoboItemData("Coin", IC.filler, 51, 0x6b, "coin_c"),
    "Coin S": ChibiRoboItemData("Coin", IC.filler, 81, 0x6b, "coin_s"),
    "Coin G": ChibiRoboItemData("Coin", IC.filler, 88, 0x6b, "coin_g"),
    "Junk A": ChibiRoboItemData("Junk", IC.filler, 92, 0x12, "item_junk_a"),
    "Junk B": ChibiRoboItemData("Junk", IC.filler, 109, 0x12, "item_junk_b"),
    "Junk C": ChibiRoboItemData("Junk", IC.filler, 126, 0x12, "item_junk_c"),
...
FILLER_ITEM_TABLE: dict[str, ChibiRoboItemData] = {
    ...
    # "Shoe Print": ChibiRoboItemData("Dust", IC.filler, 187, 0x6b, "yogore_hito"),
    # "Dust 1": ChibiRoboItemData("Dust", IC.filler, 188, 0x6b, "yogore_h_s"),
    # "Dust 2": ChibiRoboItemData("Dust", IC.filler, 189, 0x6b, "yogore_h_k"),
    # "Dust 3": ChibiRoboItemData("Dust", IC.filler, 190, 0x6b, "yogore_hun"),
    # "Dust 4": ChibiRoboItemData("Dust", IC.filler, 191, 0x6b, "yogore_shimi"),
    # "Dust 5": ChibiRoboItemData("Dust", IC.filler, 192, 0x6b, "yogore_30k"),
    # "Dust 6": ChibiRoboItemData("Dust", IC.filler, 193, 0x6b, "yogore_50k"),
    # "Dust 7": ChibiRoboItemData("Dust", IC.filler, 194, 0x6b, "yogore_kureyon_k"),
