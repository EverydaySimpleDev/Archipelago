...
ITEM_TABLE: dict[str, ChibiRoboItemData] = {
    ...
    "Living Room Ladder": ChibiRoboItemData("Item", IC.progression, 185, 0x80368522, "archipelago_item", 1, True),
    "Kitchen Ladder": ChibiRoboItemData("Item", IC.progression, 185, 0x80368526, "archipelago_item", 1, True),
    "Foyer Teleport": ChibiRoboItemData("Item", IC.progression, 185, 0x8036852c, "archipelago_item", 1, True),
    "Foyer Ladder": ChibiRoboItemData("Item", IC.progression, 186, 0x8036852a, "archipelago_item", 1, True),
    "Living Room Bridge": ChibiRoboItemData("Item", IC.progression, 186, 0x80368532, "archipelago_item", 1, True),
    "Kitchen Bridge": ChibiRoboItemData("Item", IC.filler, 186, 0x80368536, "archipelago_item", 1, True),
    "Bedroom Bridge": ChibiRoboItemData("Item", IC.filler, 186, 0x8036853a, "archipelago_item", 1, True),
    "Basement Teleport": ChibiRoboItemData("Item", IC.filler, 186, 0x8036853e, "archipelago_item", 1, True),
}
