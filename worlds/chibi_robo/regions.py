...
def create_regions(multiworld: MultiWorld, player: int, options):
    regions: Dict[str, ChibiRoboRegionData] = {
        "Menu": ChibiRoboRegionData([], ["Living Room" ]),
        "Living Room": ChibiRoboRegionData([], ["Kitchen", "Foyer", "Backyard", "Chibi House"]),
        "Chibi House": ChibiRoboRegionData([], ["Living Room" ]),
        "Kitchen": ChibiRoboRegionData([], ["Living Room", "Sink Drain", "Foyer" ]),
        "Sink Drain": ChibiRoboRegionData([], ["Kitchen"]),
        "Backyard": ChibiRoboRegionData([], ["Living Room", "UFO" ]),
        "Foyer": ChibiRoboRegionData([], ["Living Room", "Basement", "Jenny's Room", "Bedroom", "Kitchen" ]),
        "Basement": ChibiRoboRegionData([], ["Foyer" ]),
        "Jenny's Room": ChibiRoboRegionData([], ["Foyer"]),
    ...
    regions["Living Room"].locations.append("Living Room Bookshelf 10M Coin B")
