...
LOCATION_TABLE: dict[str, ChibiRoboLocationData] = {
    ...
    "Backyard - Right Awning Happy Block B": ChibiRoboLocationData(141, "Backyard", 0x08, 11, 0xde54),
    "Backyard - Left Awning Happy Block": ChibiRoboLocationData(142, "Backyard", 0x08, 12, 0xde54),
    ...
    "Backyard - White Block": ChibiRoboLocationData(145, "Backyard", 0x08, 15, 0xde54),
