...
LOCATION_TABLE: dict[str, ChibiRoboLocationData] = {
    ...
    "Living Room - Wastepaper by Trashbin A": ChibiRoboLocationData(19, "Living Room", 0x07, 8, 0xde30, 117),
    ...
    "Living Room - Armchair Candy Wrapper B": ChibiRoboLocationData(61, "Living Room", 0x07, 15, 0xde34, 442),
    "Living Room - Armchair Candy Wrapper A": ChibiRoboLocationData(62, "Living Room", 0x07, 0, 0xde34, 443),
    ...
    "Kitchen - Dog Tags Location": ChibiRoboLocationData(82, "Kitchen", 0x01, 12, 0xddca, 227),
    ...
    "Kitchen - Table Candy Wrapper A": ChibiRoboLocationData(87, "Kitchen", 0x01, 2, 0xddcc, 306),
    "Kitchen - Table Candy Wrapper B": ChibiRoboLocationData(88, "Kitchen", 0x01, 1, 0xddcc, 307),
    ...
    "Basement - Wastepaper below Dresser": ChibiRoboLocationData(114, "Basement", 0x03, 5, 0xddfc, 56),
    ...
    "Bedroom - Wastepaper by Bills A": ChibiRoboLocationData(203, "Bedroom", 0x06, 13, 0xde30, 282),
    ...
    "Bedroom - Vanity Candy Bag": ChibiRoboLocationData(214, "Bedroom", 0x06, 4, 0xde26, 293),
}
