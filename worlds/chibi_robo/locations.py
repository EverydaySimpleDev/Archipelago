...
LOCATION_TABLE: dict[str, ChibiRoboLocationData] = {
    ...
    "Living Room - Couch Wastepaper B": ChibiRoboLocationData(38, "Living Room", 0x07, 0), # Find ---
    ...
    "Kitchen - Spoon Location": ChibiRoboLocationData(68, "Kitchen", 0x01, 0), # Find ---
    ...
    "Sink Drain - Middle Row 10M Coin A": ChibiRoboLocationData(101, "Sink Drain", 0x0a, 0), # Forced Coin
    ...
    "Backyard - Twig by Glass Door": ChibiRoboLocationData(131, "Backyard", 0x09, 0, 0xde56),
