...
LOCATION_TABLE: dict[str, ChibiRoboLocationData] = {
    ...
    "Living Room - Toy receipt on coach": ChibiRoboLocationData(221, "Living Room", 0x07, 5, 0x8037de34, 302),
    ...
    "Kitchen - Wastepaper on Shelf by Toaster": ChibiRoboLocationData(222, "Kitchen", 0x01, 6, 0x8037ddcc, 154),
    "Kitchen - Cookie Crumbs under Counter": ChibiRoboLocationData(245, "Kitchen", 0x01, 7, 0x8037ddcc, 157),
    ...
    "Foyer - Wastepaper On Stairs": ChibiRoboLocationData(223, "Foyer", 0x02, 12, 0x8037dddc, 268),
    "Foyer - Candy Wrapper by Entrance": ChibiRoboLocationData(224, "Foyer", 0x02, 13, 0x8037dddc, 438),
    "Foyer - Candy Wrapper by Jenny Photo A": ChibiRoboLocationData(225, "Foyer", 0x02, 14, 0x8037dddc, 432),
    "Foyer - Candy Wrapper by Jenny Photo B": ChibiRoboLocationData(226, "Foyer", 0x02, 15, 0x8037dddc, 442),
    "Foyer - Soda Can on Shelf": ChibiRoboLocationData(227, "Foyer", 0x02, 0, 0x8037dddc, 447),
    "Foyer - Candy Wrapper by Spaceship Shelf A": ChibiRoboLocationData(228, "Foyer", 0x02, 1, 0x8037dddc, 433),
    "Foyer - Candy Wrapper by Spaceship Shelf B": ChibiRoboLocationData(229, "Foyer", 0x02, 2, 0x8037dddc, 434),
    "Foyer - Candy Wrapper by Spaceship Shelf C": ChibiRoboLocationData(242, "Foyer", 0x02, 3, 0x8037dddc, 445),
    "Foyer - Candy Wrapper on Sofa A": ChibiRoboLocationData(230, "Foyer", 0x02, 4, 0x8037dddc, 436),
    "Foyer - Candy Wrapper on Sofa B": ChibiRoboLocationData(231, "Foyer", 0x02, 5, 0x8037dddc, 437),
    "Foyer - Candy Wrapper on Floor by Door": ChibiRoboLocationData(232, "Foyer", 0x02, 6, 0x8037dddc, 435),
    "Foyer - Upstairs Wastepaper by Parents' Door": ChibiRoboLocationData(233, "Foyer", 0x02, 7, 0x8037dddc, 266),
    "Foyer - Upstairs Wastepaper by stairs": ChibiRoboLocationData(234, "Foyer", 0x02, 8, 0x8037dde2, 267),
    "Foyer - Upstairs Cookie Crumbs by stairs": ChibiRoboLocationData(235, "Foyer", 0x02, 9, 0x8037dde2, 332),
    "Foyer - Upstairs Candy Wrapper by Parents' Door": ChibiRoboLocationData(236, "Foyer", 0x02, 10, 0x8037dde2, 439),
    "Foyer - Upstairs Candy Wrapper by Jenny's Door A": ChibiRoboLocationData(237, "Foyer", 0x02, 11, 0x8037dde2, 440),
    "Foyer - Upstairs Candy Wrapper by Jenny's Door B": ChibiRoboLocationData(238, "Foyer", 0x02, 12, 0x8037dde2, 441),
    "Foyer - Candy Wrapper on Sofa C": ChibiRoboLocationData(240, "Foyer", 0x02, 13, 0x8037dde2, 443),
    "Foyer - Candy Wrapper on Lower Shelf by Entrance": ChibiRoboLocationData(241, "Foyer", 0x02, 14, 0x8037dde2, 444),
    "Foyer - Candy Wrapper on Stairs": ChibiRoboLocationData(243, "Foyer", 0x02, 15, 0x8037dde2, 446),
    "Foyer - Upstairs Soda Can": ChibiRoboLocationData(244, "Foyer", 0x02, 0, 0x8037dde2, 448),
    ...
    "Jenny's Room - Wastepaper under Bed E": ChibiRoboLocationData(239, "Jenny's Room", 0x04, 3, 0x8037de06, 160),
    ...
    "Chibi House - Ghost Suit": ChibiRoboLocationData(218, "Chibi House", 0x05, 8, 0x803684c2, None),
    "Foyer - Tao Suit": ChibiRoboLocationData(219, "Foyer", 0x02, 8, 0x803684c6, None),
    "Bedroom - Pajama Suit": ChibiRoboLocationData(220, "Bedroom", 0x06, 8, 0x803684ba, None),
}
