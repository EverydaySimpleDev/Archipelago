...
LOCATION_TABLE: dict[str, ChibiRobobLocationData] = {
    ...
    "Living Room - 10M Coin behind Grandfather Clock Shelving A": ChibiRobobLocationData(51, "Living Room", 0x7, 0x80000000),
    "Living Room - 10M Coin behind Grandfather Clock Shelving B": ChibiRobobLocationData( 52, "Living Room", 0x7, 0x80000000),
    "Living Room - 10M Coin behind Grandfather Clock Shelving C": ChibiRobobLocationData(53, "Living Room", 0x7, 0x80000000),
    "Living Room - Wastepaper above Trashbin A": ChibiRobobLocationData(54, "Living Room", 0x7, 0x80000000),
    "Living Room - Wastepaper above Trashbin B": ChibiRobobLocationData(55, "Living Room", 0x7, 0x80000000),
